({
	doInit : function(component, event, helper) {
        ...
        var action = component.get("c.getAgedTaskStatus");
		action.setCallback(this,function(response){
            var state = response.getState();        
            if (state === "SUCCESS") {
                component.set("v.AgedtaskStatusList", response.getReturnValue());
            }
        });
	...
	saveTaskStatusFun : function(component, event, helper) {
        ...
        var action = component.get("c.saveAgedTaskStatus");
        action.setParams(
            {
                "taskId": taskId,
                "status": statusVal
        ...
        // Added New 
        var action2 = component.get("c.saveAgedTaskStatus2");
        action2.setParams(
            {
                "taskId": taskId,
                "status": statusVal
