({
    ...
    save : function(component, event, helper) {
        debugger;
        //Validation for select FNM file Start
        /* var nme = document.getElementById("fileInput");
        if(nme.value.length < 4) {
            alert('Please Select FNM File');
            nme.focus();
            
            return false;
        } */
        //Validation for select FNM file END        
        ...
        if ($A.util.isEmpty(fileInput))
        {
            ...
            //alert(date);
            // var ev1t = $A.get("e.c:getdateEvent");
            
            //evt1.setParams({ApplicationDate:date})
            // evt1.fire();
            var evt = $A.get("e.c:NavigatetoLoanMenu");
        ...
        {    
            ...
            helper.Loan_Obj1(component, event, helper, date,RateType,LoanMortgageAppliedFor);  
