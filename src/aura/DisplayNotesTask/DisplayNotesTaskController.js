({
	doInit : function(component, event, helper) {
        ...
        var action = component.get("c.getNotesTaskStatus");
		action.setCallback(this,function(response){
            var state = response.getState();        
            if (state === "SUCCESS") {
                component.set("v.NotestaskStatusList", response.getReturnValue());
            }
        });
	...
	saveTaskStatusFun : function(component, event, helper) {
        ...
        var action = component.get("c.saveNotesTaskStatus");
        action.setParams(
            {
                "taskId": taskId,
                "status": statusVal
        ...
        // Added New 
        var action2 = component.get("c.saveNotesTaskStatus2");
        action2.setParams(
            {
                "taskId": taskId,
                "status": statusVal
