({
	doInit : function(component, event, helper) {
        ...
        var action = component.get("c.getConditionTaskStatus");
		action.setCallback(this,function(response){
            var state = response.getState();        
            if (state === "SUCCESS") {
                component.set("v.ConditiontaskStatusList", response.getReturnValue());
            }
        });
	...
	saveTaskStatusFun : function(component, event, helper) {
        ...
        var action = component.get("c.saveConditionTaskStatus");
        action.setParams(
            {
                "taskId": taskId,
                "status": statusVal
        ...
        // Added New 
        var action2 = component.get("c.saveConditionTaskStatus2");
        action2.setParams(
            {
                "taskId": taskId,
                "status": statusVal
