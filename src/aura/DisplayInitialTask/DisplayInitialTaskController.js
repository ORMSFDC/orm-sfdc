({
	doInit : function(component, event, helper) {
        ...
        var action = component.get("c.getInitialTaskStatus");
		action.setCallback(this,function(response){
            var state = response.getState();        
            if (state === "SUCCESS") {
                component.set("v.InitialtaskStatusList", response.getReturnValue());
            }
        });
	...
	saveTaskStatusFun : function(component, event, helper) {
        ...
        var action = component.get("c.saveInitialTaskStatus");
        action.setParams(
            {
                "taskId": taskId,
                "status": statusVal
        ...
        // Added New 
        var action2 = component.get("c.saveInitialTaskStatus2");
        action2.setParams(
            {
                "taskId": taskId,
                "status": statusVal
