({
	doInit : function(component, event, helper) {
        ...
        var action = component.get("c.getFinalTaskStatus");
		action.setCallback(this,function(response){
            var state = response.getState();        
            if (state === "SUCCESS") {
                component.set("v.FinaltaskStatusList", response.getReturnValue());
            }
        });
	...
	saveTaskStatusFun : function(component, event, helper) {
        ...
        var action = component.get("c.saveFinalTaskStatus");
        action.setParams(
            {
                "taskId": taskId,
                "status": statusVal
        ...
        // Added New 
        var action2 = component.get("c.saveFinalTaskStatus2");
        action2.setParams(
            {
                "taskId": taskId,
                "status": statusVal
