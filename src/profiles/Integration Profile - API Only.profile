<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>true</custom><description>Integration Profile - API Only with Security Token</description><userLicense>Salesforce</userLicense><classAccesses>
