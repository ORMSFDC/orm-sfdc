<?xml version="1.0" encoding="utf-8"?><Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>QLMS_AE_Notification_Emails/QLMS_AE_Contacted_notification</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>QLMS_AE_Notification_Emails/QLMS_AE_Not_Interested_notification</template>
    </alerts>
</Workflow>
