...
IF(CONTAINS(Closing_Month__c,'January  2018'),1,
IF(CONTAINS(Closing_Month__c,'February  2018'),2,
IF(CONTAINS(Closing_Month__c,'March  2018'),3,
IF(CONTAINS(Closing_Month__c,'April  2018'),4,
IF(CONTAINS(Closing_Month__c,'May  2018'),5,
IF(CONTAINS(Closing_Month__c,'June  2018'),6,
IF(CONTAINS(Closing_Month__c,'July  2018'),7,
IF(CONTAINS(Closing_Month__c,'August  2018'),8,
IF(CONTAINS(Closing_Month__c,'September  2018'),9,
IF(CONTAINS(Closing_Month__c,'October  2018'),10,
IF(CONTAINS(Closing_Month__c,'November  2018'),11,
IF(CONTAINS(Closing_Month__c,'December  2018'),12,0 )))))))))))))</formula>
